...
extension GridPageViewController : UIPageViewControllerDelegate, UIPageViewControllerDataSource {
    ...
    public func pageViewController(_ pageViewController: UIPageViewController, didFinishAnimating finished: Bool, previousViewControllers: [UIViewController], transitionCompleted completed: Bool) {
        ...
        if completed,
            let currentVC = pageViewController.viewControllers?.first as? GridCollectionViewController,
            let currentVCPage = currentVC.page {
            currentPage = currentVCPage
            currentVC.category = itemCategory
        }
